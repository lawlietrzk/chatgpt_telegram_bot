...
HELP_MESSAGE = """
I can be used as a general ChatGPT bot.
You may also share Reddit links with me so I
can summarize the post and answer your 
questions about its discussion. \n

Commands:
⚪ /retry – Regenerate last bot answer
⚪ /new – Start new dialog
⚪ /mode – Select chat mode (General Assistant bot or QA bot)
⚪ /help – Show help
...
async def start_handle(update: Update, context: CallbackContext):
    ...
    reply_text = "Hello! I'm a <b>Reddit Chatbot</b>. How can I help you?\n"
...
async def post_init(application: Application):
    await application.bot.set_my_commands([
        ...
        BotCommand("/mode", "Select chat mode - Assistant bot or QA bot"),
